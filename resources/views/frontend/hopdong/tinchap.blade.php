            ...
            <div class="container pb-6">
                <div class="row mb-6">
                    <div class="col-md-12">
                        ...
                        <h2 class="text-center">Hồ sơ đăng ký vay tín chấp</h2>
                ...
                <form action="{{route('tin-chap.create')}}" method="POST" class="form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" value="" id="ngay_sinh" name="ngay_sinh"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="col-md-5">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="">Lựa chọn khoản vay</label>
                                    <select class="form-control" name="khoan_vay" id="khoan_vay" required>
                                        @foreach($khoanvay as $item)
                                            <option value="{{$item->gia_tri}}">
