...
function initDistrict() {
    ...
    //$('#cbDistrict').select2MultiCheckboxes({
    //    templateSelection: function (selected, total) {
    //        return selected.length + " Quận/Huyện của " + total;
    //    }
    //})
...
function initSlider(producttype) {
    ...
    else if (producttype === 15) // mua nhà trả góp
    {
        ...
        $('#application_amount').slider({
            ...
            step: 1E6,
            value: 3E6,
            ticks: [3E6, 6E6, 9E6, 12E6, 15E6, 18E6, 21E6, 24E6, 27E6, 30E6],
            ticks_positions: [0, 11, 22, 33, 44, 55, 66, 77, 88, 100],
            ticks_labels: ["3tr", "6tr", "9tr", "12tr", "15tr", "18tr", "21tr", "24tr", "27tr", "30tr"],
            tooltip: "always",
            formatter: function (b) {
                $('.spanAmount').text(b.toLocaleString("en"));
                _countCalcValues(producttype);
